...
def uniqueEmail(emailId):
    ...
    if emailId in fetch_column_data('cpr_users','email'):
        return False
    else:
        return True
...
def uniqueAccNum(AccNum):
    ...
    # by fetching account_number column in CPR_accounts
    if AccNum in fetch_column_data('cpr_accounts','account_number'):
        return False
    else:
        return True
